...
class GCPConfig:
    ...
    location: str = field(default_factory=lambda: os.environ.get("GCP_LOCATION", "us-central1"))
    staging_bucket: str = field(default_factory=lambda: os.environ.get("GCP_STAGING_BUCKET", ""))
...
class ArizeConfig:
    ...
    space_key: str = field(default_factory=lambda: os.environ.get("ARIZE_SPACE_KEY", ""))
    endpoint: str = field(default_factory=lambda: os.environ.get("ARIZE_ENDPOINT", "https://api.arize.com"))
